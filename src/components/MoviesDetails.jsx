...
function MoviesDetails() {
  ...
  const { backdrop_path, poster_path, title, overview, release_date, genres ,tagline ,runtime ,credits ,videos , vote_average } =
    data;
      ...
      <div >
            ...
            <div className="hover:bg-black/10 hover:backdrop-blur-xs rounded-xl w-full md:w-10/12  h-full md:h-[70vh] md:px-5 md:py-4  text-accent1 transition-all ">
              ...
              <div className="ratings flex justify-between items-center mt-6 md:pr-10 ">
                ...
                <div className="">
                  {/* <button 
                  // onClick={handleyt}
                  className="md:px-4 md:py-2 px-2 py-1 md:text-lg text-xs bg-red-50 hover:pr-10 transition-all rounded-bl-xl rounded-tl-xl cursor-pointer">
                  </button> */}
        ...
        <div 
         style={{backgroundImage:`url('https://image.tmdb.org/t/p/original/${backdrop_path}')`}}
          ...
          <div className=" overlay h-full w-full bg-black/70 p-3 overflow-hidden ">
           <div className="cast w-full  md:p-3 py-1 flex items-center justify-items-start scroll-smooth gap-3 shrink-0 overflow-hidden whitespace-nowrap overflow-x-scroll snap-x snap-mandatory">
            ...
            {!loading ? credits?.cast.slice(0,21).map((elem , i )=>{
            ...
            Recommendation
              ...
              <div className="w-full flex items-center mt- md:p-3 py-1 justify-items-start scroll-smooth gap-3  overflow-hidden whitespace-nowrap overflow-x-scroll ">
  <Recommendation />
  <Recommendation />
  <Recommendation />
  <Recommendation />
